        ...
        <table className="w-full border-collapse border border-gray-300">
          <thead className="bg-gray-200">
            <tr>
              ...
              <th className="border border-gray-300 px-4 py-2 w-1/6">GATE Score</th>
          ...
          <tbody>
            {students.map((student) => (
              ...
              >
                ...
                <td className="border border-gray-300 px-4 py-2">{student.filledDetails ? student.gateScore : "NA"}</td>
